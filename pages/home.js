...
export default function Home() {
  return (
      ...
      <header class="max width bg" id="home">
        <div class="container">
            ...
            <div class="call">
                ...
                <div class="right">
                    <h1 class="color-laranja text-gd">𝐒𝐀𝐁𝐎𝐑 𝐃𝐈𝐕𝐈𝐍𝐎</h1>
    ...
    <div class="container">
        <div class="content">
            <div class="titulo">
                <span class="text-gd color-laranja">𝐀 𝐒𝐄𝐔 𝐅𝐀𝐕𝐎𝐑</span>
    ...
    <section class="max-width bg" id="about">
        <div class="container">
            <div class="call">
                <div class="left">
                    <span class="text-gd color-laranja">𝐒𝐎𝐁𝐑𝐄 𝐍𝐎𝐒</span>
    ...
    <section class="max-width bg" id="servicos">
        <div class="container">
            <div class="content">
                <div class="titulo">
                    <span class="text-gd color-laranja">𝐒𝐄𝐑𝐕𝐈𝐂𝐎𝐒</span>
                    <h2 class="text-gd color-cinza-1"></h2>
                </div>
                <div class="down">
                    <div class="box">
    ...
    <section class="max-width bg" id="contato">
        <div class="container">
            <div class="call">
                <div class="left">
                    <span class="text-gd color-laranja">𝐍𝐎𝐒𝐒𝐎 𝐀𝐏𝐋𝐈𝐂𝐀𝐓𝐈𝐕𝐎</span>
